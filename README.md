...
#### 🏗️ Сборка и запуск
Проект включает в себя готовый `Makefile` для автоматизации в случае утери приложения app, если в проекте уже есть приложение под названием app то тогда можете запускать его если же нету то делайте следующие действия:
